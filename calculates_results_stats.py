...
#                                                                             
# PROGRAMMER: Manasvi Agrawal
# DATE CREATED: 12-11-2024                                 
# REVISED DATE: 14-11-2024
...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic['pct_match'] = (results_stats_dic['n_match'] / 
                                      results_stats_dic['n_images']) * 100.0 if results_stats_dic['n_images'] > 0 else 0
    ...
    results_stats_dic['pct_correct_breed'] = (results_stats_dic['n_correct_breed'] / 
                                              results_stats_dic['n_dogs_img']) * 100.0 if results_stats_dic['n_dogs_img'] > 0 else 0
